...
export const SITE_TEXT = {
  fr: {
    ...
    'dashboard.title': 'Leçon un — résultats',
    'dashboard.lede':
    ...
    'dashboard.docTitle': 'Tableau de bord — Leçon un',
  ...
  en: {
    ...
    'dashboard.title': 'Lesson one — results',
    'dashboard.lede':
    ...
    'dashboard.docTitle': 'Teacher dashboard — Lesson one',
